...
async function cancel(req, res) {
  const order = await cancellationService.cancelOrder({ orderNumber: req.params.orderNumber, userId: req.user._id, reason: req.body.reason });
...
module.exports = { list, detail, invoice, cancel, purchases };
